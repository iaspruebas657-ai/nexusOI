...
missions[0] = {
  ...
  estimated_time: "20 min",
  tasks: [
    { id: "t1", text: "Escribe si estás empezando desde cero o si ya tienes un negocio.", completed: false },
    { id: "t2", text: "Describe en una frase qué vendes o qué te gustaría vender.", completed: false },
    { id: "t3", text: "Escribe cuál es tu mayor problema actual: no tengo idea, no consigo clientes, no sé vender, no sé organizarme o no sé usar herramientas digitales.", completed: false },
    { id: "t4", text: "Define qué resultado te gustaría lograr en los próximos 30 días.", completed: false }
  ],
